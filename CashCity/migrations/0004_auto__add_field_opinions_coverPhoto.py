...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opinions.coverPhoto'
        db.add_column(u'CashCity_opinions', 'coverPhoto',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['CashCity.MediaImage'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opinions.coverPhoto'
        db.delete_column(u'CashCity_opinions', 'coverPhoto_id')
