...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'CashCity_mediaimage', 'image', self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100))

        # Changing field 'Opinions.teamImage'
        db.alter_column(u'CashCity_opinions', 'teamImage', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'MediaImage.image'
        db.alter_column(u'CashCity_mediaimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Opinions.teamImage'
        db.alter_column(u'CashCity_opinions', 'teamImage', self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100))
