...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpinionSections.cropped_uploadImage_w640_h480'
        db.add_column(u'CashCity_opinionsections', 'cropped_uploadImage_w640_h480',
                      self.gf(u'django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpinionSections.cropped_uploadImage_w640_h480'
        db.delete_column(u'CashCity_opinionsections', 'cropped_uploadImage_w640_h480')
